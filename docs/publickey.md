# Public Key
Represents a commercium public key and is needed to be able to receive commercium, as is usually represented as a bitcoin [Address](address.md). See the official [Commercium Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
