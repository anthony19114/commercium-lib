# Commercium Address
Represents a bitcoin address. Addresses are the most popular way to make commercium transactions. See [the official Commercium Wiki](https://en.bitcoin.it/wiki/Address) for technical background information.

## Instantiate an Address
To be able to receive commerciums an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
