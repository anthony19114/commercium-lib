...
/**
 * Retrieve a hexa string that can be used with commerciumd's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more commerciums than the sum of the input amounts
 * @return {string}
 */
 ...
 *
 * Can receive, as output information, the output of commerciumd's `listunspent` command,
 ...
 *
 * // From a pay to public key hash output from commerciumd's listunspent
 ...
 * CheckTransaction in commercium core.
 */
...
/**
 * Analogous to commerciumd's IsCoinBase function in transaction.h
 */
